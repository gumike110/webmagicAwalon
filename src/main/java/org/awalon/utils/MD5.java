...
public abstract class MD5 {
	 ...
	 * @throws EntityException
	 */
	public static String hmac(String str, String key) throws RuntimeException {
		try {
	 ...
	 * @throws EntityException
	 */
	public static String verifyCode(File file) throws RuntimeException {
		try{
